...
struct LineGraph: View {
    ...
    var body: some View {
        GeometryReader{ proxy in
            ...
            ZStack{
                ...
                .fill(
                    LinearGradient(colors: [
                        ...
                        profit ? Color("Profit1") : Color("Loss1")
            ...
            .gesture(DragGesture().onChanged({ value in
                ...
                currentPlot = data[index].convertToCurency()
    ...
    @ViewBuilder
    func FillBackgroundGraph() -> some View {
